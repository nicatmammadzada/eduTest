...
@section('content')
    <div class="row">
        ...
        <!-- Basic layout-->
            <form action="{{route('admin.blog.update',$post->slug)}}" class="form-horizontal" method="Post"
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="centered-tab1">
                                            ...
                                            <div class="panel-heading">
                                                ...
                                                <div class="heading-elements">
                                                    <a href="{{route('admin.blog')}}"><span class="label label-success">Xəbərlərə QAYIT</span></a>
                                                </div>
                                            </div>
